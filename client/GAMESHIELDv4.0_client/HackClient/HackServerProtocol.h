...
struct SDHP_CLIENT_INFO_RECV
{
	...
	BYTE LauncherType;
	char WindowsNameLauncher[32];
	char WindowsCRCLauncher[32];
	char NameLauncher[32];
#if TESTNAMECRC
	char ClientName[32];
	char ClientNameCRC[32];
#endif
};
...
extern DWORD gMacroProtectS6Swich;
...
extern BYTE gLauncherType;
extern char gWindowsNameLauncher[32];
extern char gWindowsCRCLauncher[32];
extern char gNameLauncher[32];
#if TESTNAMECRC
extern char gClientName[32];
extern char gClientNameCRC[32];
#endif
